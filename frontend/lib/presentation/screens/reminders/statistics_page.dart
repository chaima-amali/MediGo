...
class _StatisticsContent extends StatelessWidget {
          ...
          Expanded(
            child: state.items.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, idx) {
                      final it = state.items[idx];
                      return _medicineTile(context, it);
                    },
                  ),
          ),
        ],
  ...
  /// =============================================================
  Widget _medicineTile(BuildContext context, dynamic it) {
    return InkWell(
      onTap: () async {
        TrackingCubit? trackingCubit;
        ...
        final tc = trackingCubit ?? TrackingCubit(OccurrenceRepository())
          ..loadDay(DateTime.now());
      ...
      child: Row(
        children: [
          MedicineRing(size: 72, percent: it.progress, colorHex: it.color),
          const SizedBox(width: 12),
