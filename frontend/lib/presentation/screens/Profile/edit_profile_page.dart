...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  String? _normalizeGender(String? gender) {
    ...
    if (gender == 'أنثى' || gender.toLowerCase().contains('female'))
      return 'Female';
  ...
  Future<void> _fetchLocationFromCoordinates(
    double latitude,
    double longitude,
  ) async {
    try {
  ...
  void _loadUserData() {
    ...
    if (userState is UserAuthenticated || userState is UserLoaded) {
      ...
      print(
        '   Lat: ${_currentUser?.latitude}, Lon: ${_currentUser?.longitude}',
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.lightBlue, // Always green top
      body: SafeArea(
        child: Column(
          children: [
            // Header
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: AppText.bold.copyWith(
                          fontSize: 24,
                          color: AppColors.darkBlue, // Always black
                        ),
                      ),
                    ),
                  ),
